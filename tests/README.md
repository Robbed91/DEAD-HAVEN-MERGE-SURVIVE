...
- **capture_remaining_hotspots_android** - renders those three production residence screens through a true 1080×2400 SubViewport and writes the running-game results to `docs/hotspot-captures/`, avoiding desktop monitor window-size constraints.
